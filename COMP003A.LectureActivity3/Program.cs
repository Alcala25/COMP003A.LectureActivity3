/*
   ...
   */ 
    ...
    namespace COMPA.LectureActivity3
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (inputNumber % 2 == 0)
            {
                ...
                {
                    // this code block executes if inputNumber is ivisible by 2 first, and NOT divisible by 5 after
            ...
            if (inputNumber % 2 == 0)
            {
                // this code block executes if the above condition is true he rest of the conditions will no longer execute
                Console.WriteLine("\tinputNumber is divisible by 2.");

            }
            else if (inputNumber % 3 == 0)
            {
                // this code block executes if the above condition is true the rest of the conditions will no longer execute
            ...
            switch (inputNumber)
            {
                ...
                case 5:
                    ...
                    Console.WriteLine("\tinputNumber is divisible by 5.");
                    break;
                case 7: Console.WriteLine("\tinputNumber is divisible by 7");
                    break;
                default:
